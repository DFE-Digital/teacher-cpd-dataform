...
```
8. Input SQL query below the configuration above. Ensure you change the FROM clause so that it's formatted in javascript. Replace 'xxxxx' with the value that comes directly after 'ecf-bq.dataform.'
```
${ref('xxxxx')}
```
